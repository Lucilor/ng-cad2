            ...
            if (uniqueZhankai.length != 0) {
                for (const aZhankai of uniqueZhankai) {
                    ...
                    if (needSuanliaoNameOnly) {
                        ...
                        if (suanliaodanDisplayZhankaigaoFirst) {
                            addText =
                                (showCADNameBeforeZhankai ? zhankaiName : "") + h + zhankailianjiefu + w + "=" + Cast2String(aZhankai[3]);
                        } else {
                            addText =
                                (showCADNameBeforeZhankai ? zhankaiName : "") + w + zhankailianjiefu + h + "=" + Cast2String(aZhankai[3]);
                        }
